...
layout = html.Div([
    ...
    dbc.Row([
        ...
        dbc.Col([
            dbc.Row([
                dbc.Col([
                    dbc.Card(card.card_home_productIDMuaNhieuNhat,
                             className='text-center shadow border-start border-success border-5')
                ], xs=6),
                dbc.Col([
                    dbc.Card(card.card_home_productIDDoanhThuCaoNhat,
                             className='text-center shadow border-start border-success border-5')
                ], xs=6)
            ], className='pb-1'),
            dbc.Card(card.card_home_catIDBanChayNhat,
                     className='text-center shadow border-start border-success border-5'),
        ], xs=6)
